...
if test_local:
    ...
    sampler = optunahub.load_module(
        repo_owner="malun22",  # Replace with your GitHub username.
        repo_name="optunahub-registry",  # Replace with your repository name.
        ref="PSO",
...
fig.write_html("history_pso.html", auto_open=True)